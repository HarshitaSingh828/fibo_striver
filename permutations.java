...
public class permutations{
    ...
    // public static void permutations1(String str, String ans){
    //     if(str.length()==0){
    //         System.out.println(ans);
    //         return;
    //     }
    ...
    //         permutations1(ros, ans+ str.charAt(i));
    //     }
    // }
    ...
    // public static void permutations2(String str,String ans){
    //     if(str.length()==0){
    //                  System.out.println(ans);
    //                  return;
    //             }
    ...
    //  if(map[ch-'a'] == false){
    //     map[ch-'a'] = true;
    //     permutations2(ros, ans+ str.charAt(i));
    //  }
